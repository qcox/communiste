    ...
    if string.find(string.lower(SelectedLibrary), "ui") then
        ...
        local function genKey()
            ...
            local function getKey()
                ...
                return "ui_[" .. table.concat(keys.key1) .. "-" .. table.concat(keys.key2) .. "-" .. table.concat(keys.key3) .. "-" .. table.concat(keys.key4) .. "]"
            end
            setChar("A", "Z")
            setChar("0", "9")
            return getKey()
        ...
        function Interface:Start(Configuration)
            ...
            Configuration = {
                ...
                Footer = Configuration.Footer or "undefined footer  |   " .. game.Players.LocalPlayer.Name .." | " .. os.date("%d") .. "/" .. os.date("%m") .. "/" .. os.date("%Y"),
